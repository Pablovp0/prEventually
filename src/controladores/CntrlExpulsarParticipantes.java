	...
	public void actionPerformed(ActionEvent e) {
		...
		if (s.getNusuario().equals(eventoSeleccionado.getOrganizador())) {
			...
			if (iLePanel.getParticipantesSeleccionados().size() == 0) {
				JOptionPane.showMessageDialog(cardParent, "Por favor selecciona algun participante", "Error",
				...
				JOptionPane.showMessageDialog(cardParent,
						...
						"Expulsion", JOptionPane.ERROR_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(cardParent,
			...
			JOptionPane.showMessageDialog(cardParent,
					"No puedes expulsar a un participante porque no eres el organizador.", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
}
